...
// jk tidak ada session pelnggan(blm login,).mk dilarikan ke login.php
		...
		<form method="post">
			...
			<div class="row">
				<div class="form-group">
					<input type="text" readonly value="<?php echo $_SESSION["pelanggan"]['nama_pelanggan'] ?>" class="form-group">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-4">
				...
				?>
				<option value="<?php echo $perongkir["id_onkir"] ?>">
				</option>
			<?php } ?>
		</select>
	</div>
...
<div class="from-group">
	...
	<textarea class="from-control" name="alamat-pengiriman" pleceholder="masukan alamat lengkap pengiriman(termasuk kode pos)"></textarea>
</div>
...
<pre><?php print_r($_SESSION["keranjang"]) ?></pre>
		...
		if (isset($_POST["checkout"])) 
		{
			...
			// mengkosongkan keanjang belanja
